...
> Built by **Faisal Zazai**

**SQL Explainer** is an enterprise-grade AI developer application that turns complex SQL queries into clear, logical, step-by-step plain-English walkthroughs. Powered by high-speed **Groq** and **OpenRouter** AI models with automated multi-model failover, it highlights SQL code line ranges, detects performance anti-patterns, recommends 1-click optimized queries, visualizes data pipeline flows, measures cognitive execution complexity, and transpiles queries across multiple database dialects.
...
- **CodeMirror 6 Editor**: Includes syntax highlighting, keyboard shortcuts (`Cmd + Enter`), SQL keyword auto-formatting, and interactive line-range highlighting.
...
| **AI Infrastructure** | Groq API (`llama-3.3-70b-versatile`), OpenRouter API (`llama-3.3-70b-instruct`) |
...
Deploying SQL Explainer to Vercel takes less than 2 minutes. Follow these exact steps for a clean deployment:
...
*Note: You can push this project to any GitHub account without issues.*
...
Designed and developed by **Faisal Zazai**.
